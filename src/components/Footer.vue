  ...
  <div class="mx-6 py-10 text-center md:text-left">
    <div class="grid-1 grid gap-8 md:grid-cols-2 lg:grid-cols-4">
      ...
      <div class="">
        ...
        <p>
          Bạn có thể xem được một vài thông tin cần thiết,
          thú vị từ trang web này về trò chơi thế giới mở
                         GenshinImpact
        </p>
      </div>
      <!-- Products section -->
      <div>
        ...
        <p class="mb-4">
          <a href="https://www.facebook.com/Genshinimpact/">Facebook</a>
        </p>
        <p class="mb-4">
          <a href="https://www.instagram.com/genshinimpact/">Instagram</a>
        </p>
        <p class="mb-4">
          <a href="">X</a>
        </p>
      ...
      <div>
        ...
        <p class="mb-4 flex items-center justify-center md:justify-start">
         ...
         Thành Phố HCM, 33 VINHVIEN, P2.Q10
        </p>
        <p class="mb-4 flex items-center justify-center md:justify-start">
          <span class="me-3 [&>svg]:h-5 [&>svg]:w-5">
            <svg
