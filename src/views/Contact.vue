<template>
	<section class=" w-full py-6 dark:bg-gray-100 dark:text-gray-900">
		<div class="grid max-w-6xl grid-cols-1 px-6 mx-auto lg:px-8 md:grid-cols-2 md:divide-x">
			<div class="py-6 md:py-0 md:px-6">
				<h1 class="text-4xl font-bold">Liên lạc</h1>
				<p class="pt-2 pb-4">Gửi nhận xét của bạn nơi đây.	</p>
				<div class="space-y-4">
					...
					<p class="flex items-center">
						...
						<span>bloggaming04@gmail.com</span>
					</p>
				</div>
			</div>
				<label class="block">
